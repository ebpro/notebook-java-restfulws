...
// How to get Hostname and IP Address
...
// Travailler avec une adresse IPv4 spécifique
InetAddress ipv4 = InetAddress.getByName("192.168.1.1");

System.out.println("Adresse loopback ? " + ipv4.isLoopbackAddress());
System.out.println("Adresse privée ? " + ipv4.isSiteLocalAddress());
```
:::
::::
