...
### Standards d'échange {.incremental}
...
Les services REST nécessitent l'échange de données entre client et serveur. Deux formats principaux dominent :

1. **XML (eXtensible Markup Language)**
   - Standard [W3C](https://www.w3.org/TR/xml11/)
   - Format historique et très établi
   - Riche en fonctionnalités mais verbeux

2. **JSON (JavaScript Object Notation)**
   - [Standard ECMA-404](https://www.ecma-international.org/publications-and-standards/standards/ecma-404/)
   - Format léger et populaire
   - Bien qu'initialement non standardisé pour le web, est devenu le format de facto

Ces formats nécessitent des mécanismes de conversion (sérialisation/désérialisation) entre les objets Java et leur représentation textuelle. Pour cela, Java propose plusieurs APIs standards :
- JAXB pour XML
- Jackson ou JSON-B pour JSON
:::
